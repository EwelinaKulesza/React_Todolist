...
function App() {
  ...
  // Muszę wziąc oddzielny kontekst ze stanem i wypadałoby żebym tam zrobiła reducera a w to się nie bawimy póki co

  // Status i tak jest przekazywany jako target więc nie ma sensu trzymać go w stanie
  ...
  // Poniższe poza useEffectem bo nie można łączyć hooków w taki sposób ale pewnie można jakoś lepiej
  const URL = 'https://jsonplaceholder.typicode.com/users/1/todos';
  const fetchedData = useFetch(URL);

  // Ta funkcja przekształca obiekt otrzymany fetchem na obiekt o tym samym formacie, którego to używam
  ...
  return (
    <div className="App">
      ...
      {/* // Styl - usunąć,jak już ładniej zaplanuję wygląd przycisku */}
